...
static void adc_touch_entry(void *parameter)            //Change by ChengJili at 20220710
{
    ...
    rt_device_t pdev;
    int max_range;
    rt_int16_t touch_active_cnt = 0;
    rt_bool_t  touch_active_flag = FALSE;
